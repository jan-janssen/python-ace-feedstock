...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/python-ace-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-ace-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install python-ace
```
...
It is possible to list all of the versions of `python-ace` available on your platform:
...
```
pixi search python-ace --channel conda-forge
```
